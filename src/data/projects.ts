...
export const projects: Project[] = [
  {
    ...
    description: {
      en: 'Enginering Unit Manager for Microsoft & Mobile Apps area in Teoresi\'s DigiTech division',
      it: 'Enginering Unit Manager per l\'area Microsoft & Mobile Apps nella divisione DigiTech di Teoresi',
    },
    demo: '#',
